    ...
    <IPhoneFrame>
      <section className="flex h-full flex-col bg-[#fafbfc] text-[#191f28]">
        ...
        <header className="flex h-12 shrink-0 items-center justify-between px-5">
          <Link
            href="/home?preview=1"
            className="flex min-h-11 items-center text-sm text-[#4e5968]"
          >
            홈으로
          </Link>
          <h1 className="text-[17px] font-bold">연습 기록</h1>
          <span className="w-10" />
        </header>
        <main className="min-h-0 flex-1 space-y-4 overflow-y-auto px-5 pt-4 pb-8">
          ...
          <p className="text-xs leading-5 text-[#8b95a1]">
            ...
            동기화하지 않으며, 원고·음성·분석 점수는 저장하지 않아요.
          </p>
          {error ? (
