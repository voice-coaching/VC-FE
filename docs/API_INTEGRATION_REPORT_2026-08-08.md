...
> 2026-08-25 재검증: 현재 Notion 데이터베이스는 50개, 운영 Swagger는 53개 operation입니다. Swagger에만 있는 점수 추이, 강점·약점, 약점 추천 3개는 운영 서버와 화면에서 사용 중이므로 유지합니다. 아래 본문은 2026-08-08 당시 작업 기록입니다.
...
- 운영 Swagger의 53개 Method/Path와 `ApiContract`, 원격 구현,
  계약 검증 스크립트를 다시 대조해 53/53 일치를 확인했습니다. 현재 Notion에는
  이 중 3개가 누락되어 있습니다.
